...
export const SortableBlock: React.FC<SortableBlockProps> = ({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="bg-white rounded-xl border border-[#4D694E]/20 shadow-sm overflow-hidden mb-6"
    >
      <div className="flex">
        ...
        >
          <svg
            className="w-4 h-4 text-[#4D694E]/60"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
            ...
            <button
              ...
              className={`px-6 py-3 md:py-2 rounded-lg text-sm font-semibold transition-all flex items-center justify-center space-x-2 shadow-sm min-w-[120px] ${
                isCopied
                  ...
                  : 'bg-white border border-[#4D694E]/20 text-[#4D694E] hover:bg-[#4D694E]/5'
              }`}
              type="button"
            >
